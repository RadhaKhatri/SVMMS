    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Service Type:{" "}
            {invoice.services?.length ? invoice.services.join(", ") : "—"}
          </p>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-foreground">
            My <span className="text-primary">Invoices</span>
          </h1>
        ...
        <div className="space-y-4">
          {invoices.map((invoice) => (
            <Card
              ...
              className="bg-card/50 bg-white/10 hover:border-primary/30 transition-all overflow-hidden"
            >
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button
                            ...
                            onClick={() =>
                              openInvoice(invoice.id ?? invoice.invoice_id)
                            }
                          >
                            View
                          </Button>
                        ...
                        <DialogContent className="max-w-3xl border-white bg-card bg-black max-h-[80vh] overflow-y-auto">
                          ...
                          {selectedInvoice && (
                            <Button
                              ...
                              onClick={() =>
                                downloadInvoice(selectedInvoice.invoice.id)
                              }
                            >
                          ...
                          {selectedInvoice && (
                            <Button
                              ...
                              onClick={() =>
                                sendInvoiceEmail(selectedInvoice.invoice.id)
                              }
                            >
