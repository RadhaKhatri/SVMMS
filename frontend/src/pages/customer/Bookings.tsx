                      ...
                      {taskProgress[booking.id] &&
                        ...
                        booking.status !== "cancelled" && (
                          <p className="text-sm text-muted-foreground mt-1">
                            🔧 {taskProgress[booking.id].completed} /{" "}
                            {taskProgress[booking.id].total} tasks completed
                          </p>
                        )}
            ...
            <DialogContent>
              ...
              {selectedBooking && (
                <div className="space-y-2 text-sm">
                  <p>
                    <b>Vehicle:</b> {selectedBooking.make}{" "}
                    {selectedBooking.model}
                  </p>
                  <p>
                    <b>Service Center:</b> {selectedBooking.service_center}
                  </p>
                  <p>
                    <b>Status:</b> {selectedBooking.status}
                  </p>
                  <p>
                    <b>Services:</b> {selectedBooking.services.join(", ")}
                  </p>
                  <p>
                    <b>Remarks:</b> {selectedBooking.remarks || "-"}
                  </p>
                </div>
              )}
              ...
              {jobProgress?.jobStarted ? (
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-sm mb-1">
                      Service Progress {jobProgress.summary.completed} /{" "}
                      {jobProgress.summary.total}
                    </p>
                ...
                <p className="text-muted-foreground">Job not started yet</p>
              )}
            </DialogContent>
          </Dialog>
        </Tabs>
