        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-lg border border-white/20 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {data.vehicles.map((v: any) => (
              <div
                key={v.id}
                className="bg-white/5 p-4 rounded-xl border border-white/20 hover:shadow-lg transition"
              >
                ...
                <div className="text-sm text-muted-foreground">
                  Engine: {v.engine_type || "N/A"}
                </div>
                <div className="text-sm text-muted-foreground">
                  Mileage: {v.mileage || "N/A"} km
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-lg border border-white/20 p-6">
          ...
          <div className="space-y-4">
            {data.jobCards.map((jc: any) => (
              <div
                key={jc.id}
                className="bg-white/5 border border-white/20 rounded-xl p-5 hover:shadow-lg transition"
              >
                ...
                <div className="text-sm text-muted-foreground mt-1">
                  <b>Service Center:</b> {jc.service_center_name} (
                  {jc.service_center_city})
                </div>
