...
const Register = () => {
  ...
  const [role, setRole] = useState<"customer" | "mechanic" | "service_center_manager" | "admin">("customer");
...
console.log("Selected Role:", role);
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-lg bg-card/80 backdrop-blur-md border-border/50 shadow-2xl relative z-10">
  ...
  value={role}
  onValueChange={(value) =>
    setRole(value as "customer" | "mechanic" | "service_center_manager" | "admin")
  }
  className="w-full"
>
